...
public class QueryService {
     ...
     * @return 符合条件的文档列表
     */
    public List<User> findByConditionAndSortLimit() {
        // 设置查询条件参数
        String sex = "男";
        String sort = "age";
        int limit = 2;
     ...
     * @return 符合条件的文档列表
     */
    public List<User> findByConditionAndSortSkip() {
        // 设置查询条件参数
        String sex = "男";
        String sort = "age";
        int skip = 1;
     ...
     * @return 符合条件的文档列表
     */
    public List<User> findByExistsField() {
        // 设置查询条件参数
        String field = "sex";
        // 创建条件
     ...
     * @return 符合条件的文档列表
     */
    public List<User> findByAndCondition() {
        // 设置查询条件参数
        String sex = "男";
        Integer age = 22;
        // 创建条件
     ...
     * @return 符合条件的文档列表
     */
    public List<User> findByOrCondition() {
        // 设置查询条件参数
        String sex = "男";
        int age = 22;
        // 创建条件
     ...
     * @return 符合条件的文档列表
     */
    public List<User> findByInCondition() {
        // 设置查询条件参数
        List<Integer> ageList = Lists.newArrayList(20, 22, 25);
        // 创建条件对象
     ...
     * @return 符合条件的文档列表
     */
    public List<User> findByOperator() {
        // 设置查询条件参数
        int min = 25;
        int max = 35;
        // 创建条件对象
